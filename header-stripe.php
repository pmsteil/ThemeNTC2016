...
.page-green1.district-popup {
    background: #5f3308 url(/wp-content/uploads/2016/06/bg-district-green.jpg) !important;
    border-color: #3b450b !important;
}
.page-green1.district-popup .btn-holder {
    background: #515f0c url(/wp-content/uploads/2016/06/bg-btn-holder-green.png) repeat-x !important;
}
...
.page-red.district-popup {
    background: #961d0d url(/wp-content/uploads/2016/06/bg-district-red.jpg) !important;
    border-color: #601107 !important;
}
.page-red.district-popup .btn-holder {
    background: #801a0d url(/wp-content/uploads/2016/06/bg-btn-holder-red.png) repeat-x;
}
.page-darkpurple1.district-popup {
    background: #5f3308 url(/wp-content/uploads/2016/06/bg-district-darkpurple.jpg);
    border-color: #6700CE;
}
...
.page-blue2.district-popup {
    background: #2D70B3 url(/wp-content/uploads/2016/06/bg-BOM.jpg);
    border-color: #479ACB;
}
.page-blue2.district-popup .btn-holder {
    background: #2D70B3 url(/wp-content/uploads/2016/06/bg-btn-holder-BOM.jpg) repeat-x;
} 
...
.page-navy.district-popup {
    background: #003366 url(/wp-content/uploads/2016/06/bg-district-navy.jpg);
    border-color: #00458A;
}
...
.district-popup.ext-minister-d .btn-holder{
    background: #801a0d  url(/wp-content/uploads/2016/06/bg-btn-holder-red-1.png);
    border-color: #801a0d;
}
