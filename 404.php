  ...
  <nav class="top-bar" data-topbar role="navigation">
    ...
    <section class="top-bar-section">
      ...
      <div class="dropdown_ct">
        ...
        <?php do_shortcode('[For-Churches-Drop-Down-Menu]');?>
        </li>
		<li class="has-dropdown not-click"> <a class="drop-p-bg" href="#">For District</a>	
         <?php do_shortcode('[For-Districts-Drop-Down-Menu]');?>	
        </li>
        </ul>
...
<main class="main">
  <div class="main-content-section">
    <div class="row">
      <section id="main" class="front-page-inner-ct">
        <div class="large-12 page-n-f-inner columns">
          <h2 class="p-n-f-main-title">This page cannot be found</h2>
          <p class="error_txt">Error 404</p>
        </div>
      </section>
    </div>
  </div>
