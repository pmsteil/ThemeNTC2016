<?php
/*
    Template Name: Northwest Landing 
*/
?>
...
.dropdown_ct_list li:last-child a.drop-p-bg {
    width: 170px;
    background: url(http://dev.northtexasumc.org/wp-content/uploads/2016/05/btn-for-districts-darkpurple.png) no-repeat !important;
}
.footer_right {
    margin-left: 300px;
}
