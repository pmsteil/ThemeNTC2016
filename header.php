...
<favicon>
  ...
  <link rel="icon" href="favicon.ico" type="image/x-icon">
    ...
    <link href="<?php get_template_directory_uri() ?>/css/foundation.css" rel="stylesheet" type="text/css">
     <link href='<?php get_template_directory_uri() ?>/css/custom.css' rel='stylesheet' type='text/css'>
<?php wp_head() ?>
</head>
<body <?php body_class(); ?>>
 <!--========top heder starts==============-->
